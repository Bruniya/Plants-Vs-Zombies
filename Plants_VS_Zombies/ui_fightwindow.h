...
public:
    ...
    void setupUi(QWidget *fightwindow)
    {
        ...
        label_plate = new QLabel(widget);
        label_plate->setObjectName(QStringLiteral("label_plate"));
        label_plate->setGeometry(QRect(10, 60, 51, 21));
        label_plate->setCursor(QCursor(Qt::CrossCursor));
        label_plate->setStyleSheet(QLatin1String("border-image: url(:/resource/plate.png);\n"
"color: rgb(7, 7, 7);\n"
"font: 20pt \"AcadEref\";"));
        label_plate->setAlignment(Qt::AlignCenter);
        label_plate->setMargin(0);
...
"border-image: none;"));
    ...
    void retranslateUi(QWidget *fightwindow)
    {
        ...
        label_plate->setText(QApplication::translate("fightwindow", "50", Q_NULLPTR));

...
#include "../../Plants_VS_Zombies/ibutton.h"
...
struct qt_meta_stringdata_Ibutton_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Ibutton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Ibutton_t qt_meta_stringdata_Ibutton = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Ibutton"
...
const QMetaObject Ibutton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_Ibutton.data,
      qt_meta_data_Ibutton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Ibutton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Ibutton.stringdata0))
